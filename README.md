## CSmarch
本项目用于结构化记录对于计算机科学与技术理论知识的学习内容，主要是书籍和课程。计算机科学与技术实践总结另写。
...
根据知识体系，阅读和学习相关的书籍和课程。

![](https://pic3.zhimg.com/80/f1091d496d65ebb564facaf87462596a_hd.jpg)
...
##### 高级分析 | 高级数据结构和算法 | 高级自动机理论、可计算性及复杂度
...
学习Java的基础语法，并且要注意区别C++的高级语言特性，比如接口和代理。同时需要留意许多细节，比如大数值的处理。整本书细节很多，没有练习非常容易忘记。卷Ⅱ部分暂时先不看。

###### 《Java编程语言基础》 |  课程网站：实验楼 | 状态：完成/20190807
...
###### 《C++设计模式》 | 授课教师：网易 | 状态：在学

94年出版，98年翻译为中文。整体不过时。



##### 类型系统 | 程序表示 |  | 代码生成 | 运行时系统

##### 语言翻译与执行 | 语法分析 | 编译语义分析 | 静态分析 | 并发与并行 | 形式语义 | 
...
##### 数值逻辑与数字系统 | 数据的机器级表示 | 汇编级计算机组成原理 | 存储系统的组织与结构
